...
export default function UltimaSecao(){
    return (
        <S.ThirdSectionDiv>
            ...
            <Containers title="Busque eventos sem sair do sofá" content="Com o
             ROLEZIN, você pode achar qualquer evento de seu gosto. Selecione os filtros de sua 
            ...
            <Containers title="Disponibilize rolês e eventos" content="Você tem um 
            espaço para disponibilizar, ou quer fazer algo mais caseiro, 
            mas conhecer novas pessoas? Com o ROLEZIN, você pode marcar rolês, 
